...
SELECT CONCAT("INSERT INTO Curso (nomeCurso, siglaCurso, dtCurso, descricao) VALUES ('", nomeCurso,"', '", 
											siglaCurso, "', '", 
                                            dtCurso, "', '", 
...
SELECT CONCAT("INSERT INTO Disciplina (semestre,nomeDisciplina,siglaDisciplina,totalHoras,ementa) VALUES (", semestre,", '", 
                                               nomeDisciplina,"', '", 
											                        siglaDisciplina,"', ", 
                                               totalHoras,", '", 
...
SELECT CONCAT('INSERT INTO Turno (codTurno,nomeTurno) VALUES (', codTurno, ", '", nomeTurno, "');") as '-- INSERT ON Turno' FROM Turno;
...
SELECT CONCAT("INSERT INTO Usuario VALUES ('",      senha, "', '", 
	                                            nomeUsuario, "', '", 
	                                          identificacao, "', '", 
                  											          dataNas, "', ", 
                  											              cpf, ", '", 
...
SELECT CONCAT("INSERT INTO Turma VALUES ('", siglaTurma, "', ", 
	                                           codCurso, ', ', 
	                                      codDisciplina, ', ',   
                                               anoTurma, ', ', 
                                          semestreTurma, ', ', 
...
SELECT CONCAT("INSERT INTO TabelaAlteracoes VALUES ('", usuario, "', '", horaAlteracao, "', '", tabelaAlterada, "', '", comando, "', ", linhaAlterada, ");") as "INSERT ON TabelaAlteracoes VALUES" FROM TabelaAlteracoes;